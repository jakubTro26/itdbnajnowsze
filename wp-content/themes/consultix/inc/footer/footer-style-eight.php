	...
	<div class="wraper_footer_main">
		<div class="container m">
			...
			<div class="row footer_main">
				...
				for ( $j = 1; $j <= 4; $j++ ) {
					if ( is_active_sidebar( 'consultix-footer-area-' . $j ) ) {
						echo wp_kses_post( $footer_class ) . '<div class="footer_main_item matchHeight b">';
			...
			<div class="row footer_copyright">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="footer_copyright_item text-left b">
						...
						?>
					    <p><?php echo wp_kses_post( 'Address: <br> ' ); ?><?php echo wp_kses_post( consultix_global_var( 'footer_contact_address', '', false ) ); ?></p>
					    <p class="copyright"><?php echo wp_kses_post( consultix_global_var( 'footer_copyright_bar', '', false ) ); ?></p>
					</div>
					<!-- footer_copyright_item -->
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					...
					<div class="footer_copyright_item text-right">
					    ...
					    <p><?php echo wp_kses_post( 'Connect with us' ); ?></p>
						<?php
