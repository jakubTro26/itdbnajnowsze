			...
			<div class="row header_top">
			    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 visible-lg visible-md visible-sm hidden-xs text-left">
			        ...
			        <div class="header_top_item">
						<p><?php echo esc_html( consultix_global_var( 'header_nine_header_top_contact_text', '', false ) ); ?> <a href="tel:<?php echo esc_attr( consultix_global_var( 'header_nine_header_top_contact_phone', '', false ) ); ?>"><?php echo esc_html( consultix_global_var( 'header_nine_header_top_contact_phone', '', false ) ); ?></a></p>
			        </div>
			        <!-- header_top_item -->
			    </div>
			    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
			        ...
			        <div class="header_top_item">
    					...
    					<?php endif; ?>
    					<!-- header-data-social -->
    					<div class="header-data-social c">
    					    <p><?php echo esc_html( consultix_global_var( 'header_nine_header_top_social_text', '', false ) ); ?></p>
    					    <?php
	...
	<!-- wraper_header_main -->
		...
		<div class="container">
			...
			<div class="header_main">
				<!-- brand-logo -->
				<div class="brand-logo radiantthemes-retina c">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( consultix_global_var( 'header_nine_logo', 'url', true ) ); ?>" alt="<?php esc_html_e( 'header_nine_logo', 'consultix' ); ?>"></a>
				</div>
				<!-- brand-logo -->
				<!-- responsive-nav -->
				<div class="responsive-nav hidden-lg visible-md visible-sm visible-xs" data-responsive-nav-displace="<?php echo esc_attr( consultix_global_var( 'header_nine_mobile_menu_displace', '', false ) ); ?>">
					<i class="fa fa-bars"></i>
				</div>
				<!-- responsive-nav -->
				<?php if ( true == consultix_global_var( 'header_nine_callback_button_display', '', false ) ) : ?>
				<!-- header-callback-button -->
				<div class="header-callback-button visible-lg hidden-md hidden-sm hidden-xs">
					<a class="btn" href="<?php echo esc_url( consultix_global_var( 'header_nine_callback_button_link', '', false ) ); ?>"><?php echo esc_html( consultix_global_var( 'header_nine_callback_button_text', '', false ) ); ?></a>
				</div>
				<!-- header-callback-button -->
				<?php endif; ?>
				<!-- header_main_action -->
				<div class="header_main_action visible-lg hidden-md hidden-sm hidden-xs">
					<ul>
						...
						<?php endif; ?>
						<?php if ( true == consultix_global_var( 'header_nine_search_display', '', false ) ) : ?>
							<?php if ( 'floating-search' == consultix_global_var( 'header_nine_search_style', '', false ) ) { ?>
							...
							<?php } elseif ( 'flyout-search' == consultix_global_var( 'header_nine_search_style', '', false ) ) { ?>
...
<?php if ( true == consultix_global_var( 'header_nine_search_display', '', false ) ) : ?>
	<?php if ( 'flyout-search' == consultix_global_var( 'header_nine_search_style', '', false ) ) : ?>
