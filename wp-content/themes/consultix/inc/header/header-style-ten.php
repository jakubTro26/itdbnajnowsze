			...
			<div class="row header_top">
			    ...
			    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
			        ...
			        <div class="header_top_item">
    					...
    					<?php endif; ?>
    					<!-- header-data-social -->
    					<div class="header-data-social b">
    					    <p><?php echo esc_html( consultix_global_var( 'header_ten_header_top_social_text', '', false ) ); ?></p>
    					    <?php
	...
	<?php if ( true == consultix_global_var( 'header_sticky_choose', '', false ) ) { ?>
		...
		<div class="container">
			...
			<div class="header_main">
				...
				<!-- brand-logo -->
				<!-- responsive-nav -->
				<div class="responsive-nav hidden-lg hidden-md hidden-sm visible-xs" data-responsive-nav-displace="<?php echo esc_attr( consultix_global_var( 'header_ten_mobile_menu_displace', '', false ) ); ?>">
				...
				<div class="header_main_action visible-lg visible-md visible-sm hidden-xs">
					<ul>
						...
						<?php endif; ?>
						<?php if ( true == consultix_global_var( 'header_ten_search_display', '', false ) ) : ?>
							<?php if ( 'floating-search' == consultix_global_var( 'header_ten_search_style', '', false ) ) { ?>
							...
							<?php } elseif ( 'flyout-search' == consultix_global_var( 'header_ten_search_style', '', false ) ) { ?>
...
<?php if ( true == consultix_global_var( 'header_ten_search_display', '', false ) ) : ?>
	<?php if ( 'flyout-search' == consultix_global_var( 'header_ten_search_style', '', false ) ) : ?>
