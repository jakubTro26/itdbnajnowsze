							    ...
							    <div class="nav-links">
                                    ...
                                    if( is_a( $prev_post, 'WP_Post' ) ) { ?>
    							        <div class="nav-previous">
    							            <a rel="prev" href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>" title="<?php echo esc_attr( get_the_title( $prev_post->ID ) ); ?>"><?php echo esc_html__( 'Previous Post', 'consultix' ); ?> <strong><?php echo get_the_title( $prev_post->ID ); ?></strong></a>
    							        </div>
							        <?php } ?>
							        <?php
                                    ...
                                    if( is_a( $next_post, 'WP_Post' ) ) { ?>
    							        <div class="nav-next">
    							            <a rel="next" href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" title="<?php echo esc_attr( get_the_title( $next_post->ID ) ); ?>"><?php echo esc_html__( 'Next Post', 'consultix' ); ?> <strong><?php echo esc_attr( get_the_title( $next_post->ID ) ); ?></strong></a>
    							        </div>
							        <?php } ?>
						        </div>
                            </div>
