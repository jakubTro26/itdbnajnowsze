...
if ( ! class_exists( 'RadiantThemes_Style_Tabs' ) ) {
	...
	class RadiantThemes_Style_Tabs {
		...
		public function radiantthemes_tab_style_item_func( $atts, $content = null, $tag ) {
			...
			$custom_css = ".rt-tab.element-one.rt-{$shortcode['radiant_tab_id']} 
			> ul.nav-tabs 
			> li 
			> a{ background-color: {$this->titlebg}; border-top-width: {$border_top}; border-right-width: {$border_right}; border-bottom-width: {$border_bottom}; border-left-width: {$border_left}; border-style: {$this->tab_border_style}; border-radius: {$border_radius}; text-align: {$this->tab_text_alignment}; color: {$this->titlecolor}; } .rt-tab.element-one.rt-{$shortcode['radiant_tab_id']} 
			> ul.nav-tabs 
			> li 
			> a:hover, .rt-tab.element-one.rt-{$shortcode['radiant_tab_id']} 
			> ul.nav-tabs 
			> li.active 
			> a{ background-color: {$this->titlehoverbg}; color: {$this->titlehovercolor}; } .rt-tab.element-one.rt-{$shortcode['radiant_tab_id']} 
			> .tab-content{ background-color: {$this->contentbg}; } .rt-tab.element-one.rt-{$shortcode['radiant_tab_id']} > .tab-content 
			...
			$menu_str .= '<a class="text-' . esc_attr( $this->tab_text_alignment ) . '" data-toggle="tab" href="#' . esc_attr( $shortcode['radiant_tab_id'] ) . '">';
